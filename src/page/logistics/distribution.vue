            ...
            <div class = 'right'>
                ...
                <el-dropdown trigger="click" v-if = 'type == 2' class = 'addBtn' style = 'display:inline-block' @command="handleCommand">
                    <span class="el-dropdown-link">
                        新增人员<i class="el-icon-arrow-down el-icon--right"></i>
                    </span>
                ...
                <div class = 'serBox'>
                    <input :class = "showSearch ? 'serActive':'search'" type="text" v-model="staffSearchDTO.multiCondition" placeholder="搜索" @focus="searchAct" @blur="leave">
                </div>
            </div>
        </div>
        <div class = 'table'>
            <el-table
                ...
                <template slot-scope="scope">
                    ...
                    <el-tooltip class="item" effect="dark" content="解除劳务关系" placement="top">
                    ...
                    success:(res)=>{
                        ...
                        res.list.map(v=>{
                           ...
                           if(v.status == 1){
                               ...
                               let day = Math.floor((v.proximateIndate - now) / 1000 / 3600 / 24)
                               if(day <= 30 && day > 0){//少于三十天
                                   v.timer = v.proximateDes + '剩余' + day + '天'  
                               }else if(day > 30){
